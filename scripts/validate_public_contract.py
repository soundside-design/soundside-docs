...
def main() -> int:
    ...
    require(contract["sets"]["authenticated_credit_only_tools"] == ["compose_video", "publish_content", "remix_video"], "Credit-only lane mismatch")
    ...
    require("remix_video" not in contract["sets"]["x402_eligible_tools"], "Remix cannot be x402")
