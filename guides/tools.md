...
For an assisted premise-to-film workflow with reviewed frames and accepted source windows, follow [Build an Original Short Film](./original-stories.md). It includes self-contained 30-second preview and edit requests, using ordinary MCP tools and authorized library UUIDs. It does not add an autonomous story-maker, hold/resume or quote-token API.
